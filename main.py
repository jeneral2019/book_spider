...
if __name__ == '__main__':
    ...
    # novel_id = 1042107497
    # cookie = 'supportwebp=true; supportWebp=true; newstatisticUUID=1743907582_1225967712; fu=1606796373; _csrfToken=BSVE7iDtu6UEqDVVLP6rPn4QIzag3Wi1aTLAPPMk; Hm_lvt_f00f67093ce2f38f215010b699629083=1746690382; HMACCOUNT=7A71F7CA3E240AF9; traffic_utm_referer=https%3A//cn.bing.com/; _gid=GA1.2.1124652885.1746690383; Hm_lpvt_f00f67093ce2f38f215010b699629083=1746690391; _ga_FZMMH98S83=GS2.1.s1746690382$o11$g1$t1746690390$j0$l0$h0; _ga=GA1.1.463861789.1743486831; _ga_PFYW0QLV3P=GS2.1.s1746690382$o11$g1$t1746690390$j0$l0$h0'
    # spider_url = 'https://www.22biqu.com/biqu82367/'
    # # write_desc(novel_id, spider_url, cookie)
    ...
    # novel_id = 70529
    # spider_url = 'https://www.22biqu.com/biqu70529/'
    # # write_desc(novel_id, spider_url, cookie)
    # write_desc(novel_id, spider_url, None)
    # asyncio.run(spider_book_async(novel_id))
    # write_epub(novel_id)
